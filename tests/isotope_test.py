...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('H-20Xm1',
         True),  # invalid A (string that cannot be converted to int)
...
ISOTOPE_PROPERTIES = [
    ...
    ('K-40', (3.938E16, False, 0.0117, '4-', 0., -33.53540, [['B-', 'EC'],
                                                             [89.28, 10.72]])),
    ('Co-60', (1.663E8, False, None, '5+', 0., -61.6503, [['B-'], [100.]])),
    ('U-238', (1.41E17, False, 99.2742, '0+', 0., 47.3077,
               [['A', 'SF'], [100.00, 5.4E-5]])),
    ('Pu-244', (2.525E15, False, None, '0+', 0., 59.8060, [['A', 'SF'],
                                                           [99.88, 0.12]])),
    ('Tc-99m', (21624.12, False, None, '1/2-', 0.1427, -87.1851,
                [['IT', 'B-'], [100., 3.7E-3]])),
    ('Pa-234m', (69.54, False, None, '(0-)', 0.0739, 40.413, [['IT', 'B-'],
                                                              [0.16, 99.84]])),
    ('Hf-178', (np.inf, True, 27.28, '0+', 0., -52.4352, [[], []])),
    ('Hf-178m1', (4., False, None, '8-', 1.1474, -51.2878, [['IT'], [100.]])),
    ('Hf-178m2', (9.783E8, False, None, '16+', 2.4461, -49.9891, [['IT'],
                                                                  [100.]])),
]
